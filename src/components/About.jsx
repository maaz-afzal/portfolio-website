      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative group w-fit mx-auto">
          ...
          <img
            src={profile}
            alt="Maaz Afzal"
            className="relative w-100 h-130 object-cover rounded-2xl border border-purple-500/30 shadow-xl hover:scale-105 transition duration-500"
          />
        </div>
        ...
        <div>
          ...
          <p className="text-gray-400 text-lg leading-relaxed mb-8 text-justify">
            Right now, I’m learning backend development with Node.js to become a
